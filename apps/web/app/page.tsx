...
const stats = [
  ...
  { label: "Peraturan Pemerintah (PP)", value: "856", icon: BookOpen, color: "bg-civic-amber/10 text-civic-amber" },
...
const categories = [
  ...
  { name: "Peraturan Presiden (Perpres)", count: "432", href: "/peraturan?kategori=Perpres" },
  { name: "Peraturan Menteri (Permen)", count: "2,156", href: "/peraturan?kategori=Permen" },
  { name: "Peraturan Daerah (Perda)", count: "6,789", href: "/peraturan?kategori=Perda" },
...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Categories */}
      <section>
        <h2 className="text-2xl font-bold text-foreground mb-6">Kategori Peraturan</h2>
          ...
          {categories.map((category) => (
            ...
            >
              <div>
                ...
                <p className="text-sm text-muted-foreground">{category.count} peraturan</p>
              </div>
